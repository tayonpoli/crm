...
if (isset($_POST['add_btn'])) {
    ...
    $query = "INSERT INTO employee (name, email, gender, department)
              VALUES ('$name', '$email', '$gender', '$department')";
    
    if (mysqli_query($conn, $query)) {
      echo "<script>alert('Employee Data Created!');</script>";
...
<section class="revenue">
   <h1 class="title">NEW EMPLOYEE DATA</h1>
   <form action="#" method="POST" id="add_form">
      <div class="container">
            ...
            <div class="col-lg-10 mx-auto"> 
               <div class="card shadow">
                  <div class="card-header">
                     <h4>New Employee Data</h4>
                  </div>
                  <div class="card-body p-4">
                    <div class="column">
                    <div class="col mb-3">
                            <label for="name">Name Employee</label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="Name Employee" value="<?php echo isset($name) ? $name : ''; ?>" required>
                    </div>
                    <div class="col mb-3">
                            <label for="email">Email</label>
                            <input type="text" name="email" id="email" class="form-control" placeholder="Email" value="<?php echo isset($email) ? $email : ''; ?>" required>
                    </div>
                    <div class="col mb-3">
                            <label for="gender">Gender</label>
                            <select name="gender" id="gender" class="form-control" value="<?php echo isset($gender) ? $gender : ''; ?>" required>
                    ...
                    <div class="col mb-3">
                           ...
                           <select name="department" id="department" class="form-control" value="<?php echo isset($department) ? $department : ''; ?>" required>
         ...
         <input type="submit" style="background-color: #747264" value="Add" class="btn btn-dark w-25" name="add_btn" id="add_btn">
      </div>
   </form>
</section>
